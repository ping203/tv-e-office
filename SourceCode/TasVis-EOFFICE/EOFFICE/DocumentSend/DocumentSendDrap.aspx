<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentSendDrap.aspx.cs" Inherits="EOFFICE.Document.SendDocumentSendDrap"
...
<asp:Content ContentPlaceHolderID="cphContent" runat="server" ID="ContentDocument">
    <div class="list" id="list-congvieccanlam">
        <h2>
            <span class="icon">
                <asp:Image ImageUrl="~/Images/People.png" runat="server" /></span>Công văn đi chờ duyệt</h2>
