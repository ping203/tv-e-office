<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentProcess.aspx.cs" Inherits="EOFFICE.Document.ReceivedDocumentProcess"
...
<asp:Content ContentPlaceHolderID="cphContent" runat="server" ID="ContentDocument">
    <div class="list" id="list-congvieccanlam">
        <h2>
            <span class="icon">
                <asp:Image ImageUrl="~/Images/People.png" runat="server" /></span>Công văn đến 
            cần duyệt</h2>
                ...
                <td align="left" colspan="2">
                    ...
                    <asp:GridView ID="grvListDocument" runat="server" AutoGenerateColumns="False" CssClass="tbl-list"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    Ngày gửi</HeaderTemplate>
                                <ItemTemplate>
                                   <b><%#DateTime.Parse(Eval("SendDate").ToString()).ToString("dd/MM/yyyy")%></b>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    Hạn xử lý</HeaderTemplate>
                                <ItemTemplate>
                                   <b><%#DateTime.Parse(Eval("EndProcess").ToString()).ToString("dd/MM/yyyy")%></b>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center"/>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                <a href='/DocumentSend/DocumentDetails.aspx?DocumentId=<%#Eval("DocumentId")%>'>
