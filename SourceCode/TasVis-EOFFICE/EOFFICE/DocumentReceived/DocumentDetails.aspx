<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentDetails.aspx.cs"
    Inherits="EOFFICE.ReceivedDocumentDetails" MasterPageFile="~/MasterPages/Default.Master" %>

<asp:Content ContentPlaceHolderID="cphContent" runat="server" ID="ContentUser">
    <div class="list wp-form" id="create-document">
        <h2>
            <span class="icon">
                <img src="../Images/New-document.png" /></span>Xử lý Công văn đến</h2>
        ...
        <div class="form">
            <table width="100%" cellspacing="5">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:LinkButton runat="server" ID="cmdDownAttachs" OnClick="cmdDownAttachs_Click" Visible="false">
