...
{
    [ToolboxData("<{0}:PaggingControl runat=\"server\"></{0}:PaggingControl>")]
    public class PaggingControl : WebControl, IPostBackEventHandler, INamingContainer
    {
        ...
        public enum EMode { Postback, Url };
        /// <summary>
        /// Gets or sets page size (results per page).
        /// </summary>
        private EMode _Mode = EMode.Url;
        [Category("Behavioural")]
        public EMode Mode
        {
            get { return _Mode; }
        ...
        /// </summary>
        private string _BACK_TO_PAGE = "Trang trước";
        [Category("Globalization")]
        ...
        /// </summary>
        private string _NEXT_TO_PAGE = "Trang sau";
        [Category("Globalization")]
        ...
        /// <returns></returns>
        private string GennUrl(string page)
        {
            if (Mode == EMode.Postback)
            {
                return Page.ClientScript.GetPostBackClientHyperlink(this, page);
            }
            else
            {

                if (this.Page.Request.QueryString["currentpage"]!=null)
                {
                    string strCP = this.Page.Request.QueryString["currentpage"];
                    return this.Page.Request.RawUrl.Replace("currentpage=" + strCP, "currentpage=" + page);
                }
                else
                {
                    string nc = "";
                    if (this.Page.Request.RawUrl.EndsWith(".aspx"))
                        nc = "?";
                    else
                        nc = "&";
        ...
        private string RenderFirst()
        {
            ...
            return String.Format(templateCell, GennUrl("1"));
        }
        ...
        private string RenderLast()
        {
            ...
            return String.Format(templateCell,  GennUrl(PageCount.ToString()));
        }
        ...
        private string RenderBack()
        {
            ...
            return String.Format(templateCell, GennUrl((CurrentIndex - 1).ToString()));
        }
        ...
        private string RenderOther(int pageNumber)
        {
            ...
            return String.Format(templateCell, GennUrl(pageNumber.ToString()));
        }
        ...
        private string RenderGoTo()
        {
            ...
            {
                sb.Append(string.Format(listItemTemplate, i == CurrentIndex ? "selected=\"selected\" class=\"GoToSelectedOption\"" : "", GennUrl(i.ToString()), i));
            }
