<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentEdit.aspx.cs" Inherits="EOFFICE.ReceivedDocumentEdit"
...
<asp:Content ContentPlaceHolderID="cphContent" runat="server" ID="ContentUser">
    <div class="list wp-form" id="create-document">
        <h2>
            <span class="icon">
                <img src="../Images/New-document.png" /></span>Tạo Công văn đến dự thảo</h2>
        <form>
        ...
        <div class="form">
            <table width="100%" cellspacing="5">
                <tr>
                    <td>
                        Loại Công văn đến:<span class="required">*</span>
                    </td>
                    <td colspan="3">
                        <asp:DropDownList runat="server" DataTextField="Name" Width="250" DataValueField="DocumentKindID"
                            ID="ddlType">
                        </asp:DropDownList>
                        <a href="/DocumentReceived/DocumentKindCreate.aspx" runat="server" id="lnkAddCategory" class="link-btn">Thêm loại Công văn đến</a>
                    </td>
                </tr>
                <tr>
                    <td>
