...
{
    public partial class DefaultSendAgain : System.Web.UI.Page
    {
        #region "Propertys"
        /// <summary>
        /// Trang hiện tại
        ...
        private void BindData()
        {
            ...
            IList<ODocument> lst = ctl.Get("", txtKey.Text, StartDate, EndDate, int.Parse(Common.DocumentType.DocumentDrap.ToString("D")), 0, "", int.Parse(EOFFICE.Common.DocumentStatus.SendAgain.ToString("D")), "Name", "DESC", Global.UserInfo.UserID, int.Parse(hdfCurrentPage.Value), pagesize,int.Parse( EOFFICE.Common.DocumentType.DocumentDrap.ToString("D")));
