<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditAssignment.aspx.cs" Inherits="EOFFICE.Works.EditAssignment" MasterPageFile="~/MasterPages/Default.Master" %>
<asp:Content ContentPlaceHolderID="cphContent" ID="ContentDefault" runat="server">        
<div class="list wp-form" id="createWork">
            	<h2><span class="icon"><img src="../Images/New-document.png" /></span>Chỉnh sửa công việc</h2>
                    
                	<div class="nav-function">
                    	<ul>
                        	<li><asp:Button ID="btnSave" runat="server" Text="Cập nhật" CssClass="btn" onclick="btnSave_Click" OnClientClick='return get_check_value();'></asp:Button></li>
                	...
                	<table width="100%" cellspacing="5">
                        ...
                        <tr>
                            <td align="right">File đã đính kèm:</td>
                            <td>
                        ...
                        <tr>
                        	<td align="right">Thêm File đính kèm: </td>
                            <td>
                    ...
                    <div class="nav-function">
                    	<ul>
                        	<li><asp:Button ID="btnSave2" runat="server" Text="Cập nhật" OnClick="btnSave_Click" CssClass="btn" OnClientClick='return get_check_value();'   
                                    ></asp:Button></li>
