...
namespace EOFFICE.Document
{
    public partial class DefaultSendAgain : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            IList<ODocument> lst = ctl.Get("", txtKey.Text, StartDate, EndDate, int.Parse(ddlDocumentType.SelectedValue), 0, "", int.Parse(EOFFICE.Common.DocumentStatus.SendAgain.ToString("D")), "Name", "DESC",Global.UserInfo.UserID, int.Parse(hdfCurrentPage.Value ), pagesize);
