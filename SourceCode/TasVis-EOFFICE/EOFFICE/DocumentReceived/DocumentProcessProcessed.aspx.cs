...
{
    public partial class ReceivedDocumentProcessProcessed : System.Web.UI.Page
    {
        #region "Propertys"
        /// <summary>
        /// Trang hiện tại
        ...
        private void BindData()
        {
            ...
            if (!ctlUP.HasPermission(Global.UserInfo.UserID, Common.PermissionCode.DocumentReceivedPublish.ToString()) && !Global.IsAdmin())
                Response.Redirect("/");
