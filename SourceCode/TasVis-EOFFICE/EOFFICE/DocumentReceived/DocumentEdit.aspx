<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentEdit.aspx.cs" Inherits="EOFFICE.DocumentReceived.DocumentEdit"
...
<asp:Content ContentPlaceHolderID="cphContent" runat="server" ID="ContentUser">
    <div class="list wp-form" id="create-document">
        <h2>
            <span class="icon">
                <img src="../Images/New-document.png" /></span>Tạo công văn đến</h2>
        <form>
        <div class="nav-function">
            <ul>
                <li>
                    <asp:LinkButton runat="server" ID="lnkSave" CssClass="btn" OnClientClick="javascript:return $('form').valid();"  OnClick="lnkSave_Click"><img src="../Images/Save.png" />Lưu công văn đến</asp:LinkButton>
                </li>
            ...
            <ul>
                <li>
                    <asp:LinkButton runat="server" ID="lnkSave1" CssClass="btn" 
                        onclick="lnkSave_Click" OnClientClick="javascript:return $('form').valid();" ><img src="../Images/Save.png" />Lưu công văn đến</asp:LinkButton>
                </li>
                <li style="display:none">
