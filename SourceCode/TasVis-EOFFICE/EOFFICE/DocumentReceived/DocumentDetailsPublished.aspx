<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentDetailsPublished.aspx.cs"
    Inherits="EOFFICE.ReceivedDocumentDetailsPublished" MasterPageFile="~/MasterPages/Default.Master" %>

<asp:Content ContentPlaceHolderID="cphContent" runat="server" ID="ContentUser">
    <div class="list wp-form" id="create-document">
        <h2>
            <span class="icon">
                <img src="../Images/New-document.png" /></span>Phát hành Công văn đến</h2>
