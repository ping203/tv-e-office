<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentProcessedUser.aspx.cs" Inherits="EOFFICE.Document.ReceivedDocumentProcessedUser"
...
<asp:Content ContentPlaceHolderID="cphContent" runat="server" ID="ContentDocument">
    <div class="list" id="list-congvieccanlam">
        <h2>
            <span class="icon">
                <asp:Image ImageUrl="~/Images/People.png" runat="server" /></span>Công văn đến đã duyệt</h2>
