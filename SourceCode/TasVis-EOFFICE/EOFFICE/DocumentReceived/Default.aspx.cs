...
namespace EOFFICE.DocumentReceived
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            IList<ODocument> lst = ctl.Get("", txtKey.Text, StartDate, EndDate, int.Parse( Common.DocumentType.DocumentReceived.ToString("D")), 0, "", int.Parse(EOFFICE.Common.DocumentStatus.SaveDrap.ToString("D")), "Name", "DESC",Global.UserInfo.UserID, int.Parse(hdfCurrentPage.Value ), pagesize);
        ...
        protected void grvListDocument_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("cmdEdit", StringComparison.OrdinalIgnoreCase))
            {
                ...
                Response.Redirect("/DocumentReceived/DocumentEdit.aspx?DocumentId=" + e.CommandArgument.ToString());
            }
            //--Xóa  văn bản
