...
{
    public partial class SendDocumentProcess : System.Web.UI.Page
    {
        #region "Propertys"
        /// <summary>
        /// Trang hiện tại
        ...
        private void InitData()
        {
            ...
            if (!ctlUP.HasPermission(Global.UserInfo.UserID, Common.PermissionCode.DocumentSendProcess.ToString())&& !Global.IsAdmin())
