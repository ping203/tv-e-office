...
namespace EOFFICE.Document
{
    public partial class DocumentProcessProcessed : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            IList<ODocument> lst = ctl.Get("", txtKey.Text, StartDate, EndDate, int.Parse(ddlDocumentType.SelectedValue), 0, Global.UserInfo.UserID.ToString(), int.Parse(EOFFICE.Common.DocumentStatus.Published.ToString("D")), "Name", "DESC",0, int.Parse(hdfCurrentPage.Value ), pagesize);
