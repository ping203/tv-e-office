...
namespace EOFFICE
{
    public partial class SendDocumentKindCreate : System.Web.UI.Page
    {
        #region "Propertys"
        /// <summary>
        /// Trang hiện tại
        ...
        protected void grvDocumentKind_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName.Equals("cmdDelete", StringComparison.OrdinalIgnoreCase))
            {
                ...
                if(ctl.Delete(int.Parse(e.CommandArgument.ToString())))
                    ...
                    RegisterClientScriptBlock("Notification", "<script language='javascript'>alert('Đã tồn tại Công văn đi trong loại này!');</script>");
